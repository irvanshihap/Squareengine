    ...
    With frmMain
        ...
        Select Case ButtonPressed
            Case 1 'Actual Task
                ...
                QuestSubtitle = "Actual Task [" + Trim$(Player(MyIndex).PlayerQuest(QuestNum).ActualTask) + "]"
            ...
            Case 3 'Quest Status
                ...
                If Player(MyIndex).PlayerQuest(QuestNum).status = QUEST_STARTED Then
                    QuestSay = "Quest in Progress. Step " & Player(MyIndex).PlayerQuest(QuestNum).ActualTask & "."
