...
Begin VB.Form frmEditor_Events 
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbPositioning 
         ...
         Left            =   120
         List            =   "frmEditor_Events.frx":003C
         Style           =   2  'Dropdown List
         TabIndex        =   103
         Top             =   360
         Width           =   3135
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbTrigger 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0078
         Left            =   120
         List            =   "frmEditor_Events.frx":0085
         Style           =   2  'Dropdown List
         TabIndex        =   25
         Top             =   240
         Width           =   3135
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbMoveFreq 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":00CA
         Left            =   840
      ...
      Begin VB.ComboBox cmbMoveSpeed 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0109
         Left            =   840
         List            =   "frmEditor_Events.frx":011F
         Style           =   2  'Dropdown List
         TabIndex        =   17
         Top             =   1200
         Width           =   2415
      ...
      Begin VB.ComboBox cmbMoveType 
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0162
         Left            =   840
         List            =   "frmEditor_Events.frx":016F
         Style           =   2  'Dropdown List
         TabIndex        =   15
         Top             =   360
         Width           =   2415
   ...
   Begin VB.Frame fraRandom 
      ...
      Begin VB.ComboBox cmbPlayerVarCompare 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0197
         Left            =   3720
         List            =   "frmEditor_Events.frx":01AD
         Style           =   2  'Dropdown List
         TabIndex        =   309
         Top             =   240
         Width           =   1335
      ...
      Begin VB.ComboBox cmbSelfSwitchCompare 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0213
         Left            =   3720
         List            =   "frmEditor_Events.frx":021D
         Style           =   2  'Dropdown List
         TabIndex        =   308
         Top             =   1680
         Width           =   1095
      ...
      Begin VB.ComboBox cmbPlayerSwitchCompare 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":022E
         Left            =   3720
         List            =   "frmEditor_Events.frx":0238
         Style           =   2  'Dropdown List
         TabIndex        =   305
         Top             =   720
         Width           =   1095
      ...
      Begin VB.ComboBox cmbSelfSwitch 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0249
         Left            =   1920
         List            =   "frmEditor_Events.frx":025C
         Style           =   2  'Dropdown List
         TabIndex        =   97
         Top             =   1680
         Width           =   1455
      ...
      Begin VB.ComboBox cmbHasItem 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0282
         Left            =   1920
         List            =   "frmEditor_Events.frx":0284
         Style           =   2  'Dropdown List
         TabIndex        =   9
         Top             =   1200
         Width           =   1455
      ...
      Begin VB.ComboBox cmbPlayerSwitch 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":0286
         Left            =   1920
         List            =   "frmEditor_Events.frx":0288
         Style           =   2  'Dropdown List
         TabIndex        =   7
         Top             =   720
         Width           =   1455
      ...
      Begin VB.ComboBox cmbPlayerVar 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmEditor_Events.frx":028A
         Left            =   1920
         List            =   "frmEditor_Events.frx":028C
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   240
         Width           =   1455
   ...
   Begin VB.Frame fraDialogue 
      ...
      Begin VB.Frame fraCommand 
         ...
         Visible         =   0   'False
         Width           =   4095
         Begin VB.HScrollBar scrlQuestNumber 
            Height          =   255
            Left            =   120
            TabIndex        =   431
            Top             =   960
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbChatBubbleTarget 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":028E
            Left            =   1920
            List            =   "frmEditor_Events.frx":0290
            Style           =   2  'Dropdown List
            TabIndex        =   370
            Top             =   1560
            Visible         =   0   'False
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbChangeItemIndex 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0292
            Left            =   120
            List            =   "frmEditor_Events.frx":0294
            Style           =   2  'Dropdown List
            TabIndex        =   237
            Top             =   480
            Width           =   1695
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbChangeSkills 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0296
            Left            =   120
            List            =   "frmEditor_Events.frx":0298
            Style           =   2  'Dropdown List
            TabIndex        =   247
            Top             =   480
            Width           =   3735
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbWarpPlayerDir 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":029A
            Left            =   120
            List            =   "frmEditor_Events.frx":02AD
            Style           =   2  'Dropdown List
            TabIndex        =   303
            Top             =   2040
            Width           =   3855
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlayerSwitchSet 
            ...
            Left            =   960
            List            =   "frmEditor_Events.frx":02F8
            Style           =   2  'Dropdown List
            TabIndex        =   209
            Top             =   800
            Width           =   3015
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbSetSelfSwitch 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0309
            Left            =   1440
            List            =   "frmEditor_Events.frx":0319
            Style           =   2  'Dropdown List
            TabIndex        =   212
            Top             =   360
            Width           =   2535
         ...
         Begin VB.ComboBox cmbSetSelfSwitchTo 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0329
            Left            =   960
            List            =   "frmEditor_Events.frx":0333
            Style           =   2  'Dropdown List
            TabIndex        =   211
            Top             =   800
            Width           =   3015
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbChangeClass 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0340
            Left            =   120
            List            =   "frmEditor_Events.frx":0342
            Style           =   2  'Dropdown List
            TabIndex        =   251
            Top             =   480
            Width           =   3735
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbSpawnNPC 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0344
            Left            =   120
            List            =   "frmEditor_Events.frx":0346
            Style           =   2  'Dropdown List
            TabIndex        =   393
            Top             =   480
            Width           =   3735
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlayAnim 
            ...
            Left            =   1680
            List            =   "frmEditor_Events.frx":034A
            Style           =   2  'Dropdown List
            TabIndex        =   285
            Top             =   300
            Width           =   3135
         ...
         Begin VB.ComboBox cmbPlayAnimEvent 
            ...
            Left            =   1920
            List            =   "frmEditor_Events.frx":034E
            Style           =   2  'Dropdown List
            TabIndex        =   273
            Top             =   1440
            Visible         =   0   'False
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbOpenShop 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0350
            Left            =   960
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox CmbWeather 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":03A6
            Left            =   120
            List            =   "frmEditor_Events.frx":03BC
            Style           =   2  'Dropdown List
            TabIndex        =   404
            Top             =   480
            Width           =   1815
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlayBGM 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":03EB
            Left            =   1080
            List            =   "frmEditor_Events.frx":03ED
            Style           =   2  'Dropdown List
            TabIndex        =   294
            Top             =   360
            Width           =   3135
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbPlaySound 
            ...
            Left            =   960
            List            =   "frmEditor_Events.frx":03F1
            Style           =   2  'Dropdown List
            TabIndex        =   296
            Top             =   360
            Width           =   3135
      ...
      Begin VB.Frame fraCommand 
         ...
         Begin VB.ComboBox cmbSetAccess 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":03F3
            Left            =   960
            List            =   "frmEditor_Events.frx":0406
            Style           =   2  'Dropdown List
            TabIndex        =   317
            Top             =   360
            Width           =   3135
      ...
      Begin VB.Frame fraCommand 
         ...
         Visible         =   0   'False
         Width           =   6135
         Begin VB.HScrollBar scrlFinishedQuest 
            Enabled         =   0   'False
            Height          =   255
            Left            =   1920
            TabIndex        =   434
         ...
         Begin VB.ComboBox cmbCondition_SelfSwitch 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0449
            Left            =   1920
            List            =   "frmEditor_Events.frx":0459
            Style           =   2  'Dropdown List
            TabIndex        =   300
            Top             =   3720
            Width           =   1695
         ...
         Begin VB.ComboBox cmbCondition_SelfSwitchCondition 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0469
            Left            =   3960
         ...
         Begin VB.ComboBox cmbCondition_LearntSkill 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0484
            Left            =   1920
            List            =   "frmEditor_Events.frx":0486
            Style           =   2  'Dropdown List
            TabIndex        =   178
            Top             =   2760
            Width           =   1695
         ...
         Begin VB.ComboBox cmbCondition_ClassIs 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0488
            Left            =   1920
            List            =   "frmEditor_Events.frx":048A
            Style           =   2  'Dropdown List
            TabIndex        =   177
            Top             =   2280
            Width           =   1695
         ...
         Begin VB.ComboBox cmbCondition_HasItem 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":048C
            Left            =   1920
            List            =   "frmEditor_Events.frx":048E
            Style           =   2  'Dropdown List
            TabIndex        =   176
            Top             =   1920
            Width           =   1695
         ...
         Begin VB.ComboBox cmbCondtion_PlayerSwitchCondition 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":0490
            Left            =   3960
            List            =   "frmEditor_Events.frx":049A
            Style           =   2  'Dropdown List
            TabIndex        =   175
            Top             =   1080
            Width           =   1095
         ...
         Begin VB.ComboBox cmbCondition_PlayerSwitch 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":04AB
            Left            =   1920
            List            =   "frmEditor_Events.frx":04AD
            Style           =   2  'Dropdown List
            TabIndex        =   174
            Top             =   1080
            Width           =   1695
         ...
         Begin VB.ComboBox cmbCondition_LevelCompare 
            Enabled         =   0   'False
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":04AF
            Left            =   1440
            List            =   "frmEditor_Events.frx":04C5
            Style           =   2  'Dropdown List
            TabIndex        =   172
            Top             =   3240
            Width           =   1695
         ...
         Begin VB.ComboBox cmbCondition_PlayerVarCompare 
            Height          =   315
            ItemData        =   "frmEditor_Events.frx":052B
            Left            =   1920
            List            =   "frmEditor_Events.frx":0541
            Style           =   2  'Dropdown List
            TabIndex        =   168
            Top             =   720
            Width           =   1695
         ...
         Begin VB.CommandButton cmdCondition_Cancel 
            ...
            Width           =   1215
         End
         Begin VB.Label lblFinishedQuest 
            Height          =   255
            Left            =   2040
            TabIndex        =   435
            Top             =   1440
...
If Not isEdit Then
        AddCommand EventType.evGiveQuest
    Else
        EditCommand
    End If
    ' hide
...
Dim i As Long, x As Long
    ...
    Select Case x
        ...
        Case 7
            scrlFinishedQuest.Enabled = True
    End Select
End Sub
...
Private Sub scrlFinishedQuest_Change()
lblFinishedQuest.Caption = scrlFinishedQuest.value & " - " & Quest(scrlFinishedQuest.value).name
End Sub
...
Private Sub scrlQuestNumber_Change()
    lblQuestName.Caption = "Quest: " & scrlQuestNumber.value & " - " & Quest(scrlQuestNumber.value).name
End Sub
