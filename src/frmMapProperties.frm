...
Begin VB.Form frmEditor_MapProperties 
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox cmbPanorama 
         ...
         Left            =   120
         List            =   "frmMapProperties.frx":005C
         TabIndex        =   58
         Text            =   "cmbPanorama"
         Top             =   1560
         Width           =   1815
   ...
   Begin VB.Frame fraMapSettings 
      ...
      Begin VB.ComboBox cmbDayNight 
         Height          =   315
         ItemData        =   "frmMapProperties.frx":0085
         Left            =   960
         List            =   "frmMapProperties.frx":0092
         TabIndex        =   56
         Text            =   "cmbDayNight"
         Top             =   600
         Width           =   3135
      ...
      Begin VB.ComboBox cmbMoral 
         Height          =   315
         ItemData        =   "frmMapProperties.frx":00B8
         Left            =   960
         List            =   "frmMapProperties.frx":00C5
         Style           =   2  'Dropdown List
         TabIndex        =   14
         Top             =   240
         Width           =   3135
