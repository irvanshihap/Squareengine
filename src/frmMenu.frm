...
Begin VB.Form frmMenu 
   ...
   Begin VB.PictureBox picCharacter 
      ...
      Begin VB.ComboBox cmbClass 
         ...
         ForeColor       =   &H00000000&
         Height          =   330
         ItemData        =   "frmMenu.frx":014A
         Left            =   2280
         List            =   "frmMenu.frx":014C
   ...
   Begin VB.PictureBox picCredits 
      ...
      Begin VB.Label Label1 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   "SkywardRiver, Carim, Benjo, Robin,  Scott, Alatar, Ryoku Hassu"
         BeginProperty Font 
            Name            =   "Georgia"
            Size            =   12
            Charset         =   0
...
LoadClasses
    ...
    newCharSprite = 0
    lblClassDesc.Caption = Class(cmbClass.ListIndex + 1).Desc
End Sub
